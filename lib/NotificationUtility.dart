...
class NotificationUtility {
  // 使用单例模式进行初始化
  static final NotificationUtility _instance = NotificationUtility._internal();
  factory NotificationUtility() => _instance;
...
//  显示通知
  Future<void> showNotification(
    ...
    AndroidNotificationDetails('normal', '联系人消息',
        channelDescription: '好友发送的消息',
